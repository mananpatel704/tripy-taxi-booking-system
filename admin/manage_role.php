...
<!--                    <li class="breadcrumb-item">DataTables</li> -->
            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Role Table</div>
                    </div>
                    <div class="ibox-body">
                        <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="role_edit.php?role_id=<?php echo $role_row['role_id'];?>">edit</a></td>
                                    <td><a href="role_delete.php?role_id=<?php echo $role_row['role_id'];?>">delete</a></td>
