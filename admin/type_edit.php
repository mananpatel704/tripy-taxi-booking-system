...
$type_data=mysqli_query($conn,"select * from tripy_type where type_id=$type_id");
$type_row=mysqli_fetch_array($type_data);
if(isset($_POST['submit']))
{
    $type_title=$_POST['type_title'];
   $query=mysqli_query($conn,"update  tripy_type set type_title='$type_title'where type_id=$type_id");
   if($query)
   {
                                ...
                                <form action="" method="post">
                                    <div class="row">
                                        <div class="col-sm-12 form-group">
                                            ...
                                            <input class="form-control" type="text" placeholder="Role Title" name="type_title"  value="<?php echo $type_row['type_title'];?>">
                                        </div>
